...
set :application, "dwkebabs"
set :repo_url, "git@github.com:thedeadweather/bbqevent.git"

# Default branch is :master
# ask :branch, `git rev-parse --abbrev-ref HEAD`.chomp

# Default deploy_to directory is /var/www/my_app_name
set :deploy_to, "/home/deploy/apps/kebabs"
...
# restart worker after server restart
